...
# =============================================================================
# Here I provided solutions to unigram, bigram and trigram featurization, uncomment
# certain parts to use the corresponding functions. 
# =============================================================================
...
class Corpus(ABC):
    ...
    def featurize_documents(self, vocabs=None):
        ...
        The featurization varies depending on different corpus type.
        For the name corpus, there is no vocabulary, and the featurization is done 
        on alphabet basis otherwise the featurization is done on vocabulary basis"""
        if vocabs == None:
...
class PDTBCorpus(Corpus):
    ...
    def compile_vocab(self, most_common_n: int = -1):
       ...
       """
        ...
        if most_common_n > 0:
            most_common = sorted(wordCount, key=wordCount.get, reverse=True)[:most_common_n]
