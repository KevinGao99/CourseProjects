...
class CallAuction(object):
    ...
    def plot_supply_vs_demand(self):
        ...
        ax.plot(prices, supply_qty, color='r', label="Supply")
    ...
    def plot_orderbook(self):
        ...
        ax.bar(list(self.ask_side.keys()), list(self.ask_side.values()), color='r',
...
def main():
    ...
    if call_auction.compute_clearing_price():
        ...
        print(call_auction.clearing_price, call_auction.clearing_qty)
    else:
